...
#pragma omp parallel for
		for (int tri_index = 0; tri_index < all_models[model_index].faceSets.size(); tri_index++)
		{
			...
			int firstTextIndex = all_models[model_index].faceSets[tri_index].first_point_texture_index;//纹理顶点索引
			int secondTextIndex = all_models[model_index].faceSets[tri_index].second_point_texture_index;
			int thirdTextIndex = all_models[model_index].faceSets[tri_index].third_point_texture_index;
			...
			my_2D_Texture_coord p1TextCoord = all_models[model_index].pointTextureSets[firstTextIndex];//第一个点的纹理坐标
			my_2D_Texture_coord p2TextCoord = all_models[model_index].pointTextureSets[secondTextIndex];//第二个的纹理坐标
			my_2D_Texture_coord p3TextCoord = all_models[model_index].pointTextureSets[thirdTextIndex];//第三个点的纹理坐标
