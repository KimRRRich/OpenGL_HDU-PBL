...
void init(void)
{
	...
	//加载模型
	//////////////////////////////////模型 桌子/////////////////////////////////////////////////
	ObjLoader objLoader1 = ObjLoader("newdesk.obj");
	float obj1_material_diffuse_rgb_reflection[] = { 0.5, 0.7, 0.8 };
	objLoader1.my_3DModel.modify_color_configuration( 9, 1, material_ambient_rgb_reflection, obj1_material_diffuse_rgb_reflection, material_specular_rgb_reflection, ns);
	...
	DeleteObject(hBMP1);
	//////////////////////////////////模型 房间/////////////////////////////////////////////////
	ObjLoader objLoader2 = ObjLoader("newroom3.obj");
	float obj2_material_diffuse_rgb_reflection[] = { 0.6, 0.4, 0.4 };
	objLoader2.my_3DModel.modify_color_configuration(9, 1, material_ambient_rgb_reflection, obj2_material_diffuse_rgb_reflection, material_specular_rgb_reflection, ns);
	...
	objLoader3.my_3DModel.modify_color_configuration(9, 1, material_ambient_rgb_reflection, obj3_material_diffuse_rgb_reflection, material_specular_rgb_reflection, ns);
	...
	float obj4_material_diffuse_rgb_reflection[] = { 0.7, 0.7, 0.8 };
	objLoader4.my_3DModel.modify_color_configuration(9, 1, material_ambient_rgb_reflection, obj4_material_diffuse_rgb_reflection, material_specular_rgb_reflection, ns);
	...
	DeleteObject(hBMP4);
	//////////////////////////////////模型 ball/////////////////////////////////////////////////
	ObjLoader objLoader5 = ObjLoader("ball128.obj");
	float obj5_material_diffuse_rgb_reflection[] = { 0.8, 0.9, 0.8 };
	objLoader5.my_3DModel.modify_color_configuration(9, 1, material_ambient_rgb_reflection, obj5_material_diffuse_rgb_reflection, material_specular_rgb_reflection, ns);
	all_models.push_back(objLoader5.my_3DModel);
	glGenTextures(1, &textName[4]);
	wchar_t file_path5[] = L"glass.bmp";
